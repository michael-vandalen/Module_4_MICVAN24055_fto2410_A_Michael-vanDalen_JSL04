...
console.log(userPreference === "Sugar-free" ? "Sugar-free" : "Regular"); // If userPreference equal to Sugar-free = "Sugar-free", else "Regular"
// #### Challenge 2: Stock Check
// You have a variable that tracks the number of Monster Energy cans left in the fridge.
// Use a ternary operator to print "Time to restock!" if the number is less than 5, or "We're stocked!" if the number is 5 or more.

let cansLeft = 5; // Any number of cans
console.log(cansLeft < 5 ? "Time to restock" : "We're stocked!"); // If cansLeft less than 5 = "Time to restock", else "We're stocked!"
...
console.log(heartRate < 100 ? "Boost needed!" : "Energy levels are high!"); // If heartRate less than 100 = "Boost Needed", else "Energy levels are high!"
...
console.log(currentTemp <= 5 ? "Chilled to perfection!" : "Needs a cooler!"); // If currentTemp less or equal to 5°C = "Chilled to perfection!", else "Needs a cooler!"
...
); // If currentHour greater than 7 and less than 24 = "Unleash the beast!", else "Better stick to water."
